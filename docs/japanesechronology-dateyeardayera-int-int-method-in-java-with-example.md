# Java 中的 Japanese 年表 dateYearDay(Era，int，int)方法，示例

> 原文:[https://www . geeksforgeeks . org/Japanese 年表-datyeardayera-int-int-method-in-Java-with-example/](https://www.geeksforgeeks.org/japanesechronology-dateyeardayera-int-int-method-in-java-with-example/)

**Java . time . chrono . Japanese 年表**类的 **dateYearDay()** 方法用于根据特定时代的日本日历检索日本日期。
