...
链接 Java 中的 LinkedHashSet retainAll()方法

> 原文:[https://www . geeksforgeeks . org/link edhashset-retailnall-method-in-Java-with-example/](https://www.geeksforgeeks.org/linkedhashset-retainall-method-in-java-with-example/)

**java.util.LinkedHashSet** 类的**retainnal()**方法用于从该集合中保留指定集合中包含的所有元素。
