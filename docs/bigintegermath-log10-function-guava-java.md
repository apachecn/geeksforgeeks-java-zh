# bigentermath log10()函数|番石榴| Java

> 原文:[https://www . geesforgeks . org/bigintermath-log 10-function-guava-Java/](https://www.geeksforgeeks.org/bigintegermath-log10-function-guava-java/)

[番石榴的 BigIntegerMath 类](https://www.geeksforgeeks.org/bigintegermath-class-guava-java/)的方法**log10(bigintermate x，舍入模式)**返回 x 的以 10 为底的对数，根据指定的舍入模式进行舍入。
...
*   **Mode** : The rounding mode for calculating the logarithm of 10.
...
**参考:**[https://Google . github . io/guava/releases/21.0/API/docs/com/Google/common/math/bigintermath . html # log10-Java . math . biginger-Java . math . round ingmode-](https://google.github.io/guava/releases/21.0/api/docs/com/google/common/math/BigIntegerMath.html#log10-java.math.BigInteger-java.math.RoundingMode-)