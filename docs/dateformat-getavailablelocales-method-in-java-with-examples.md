# Java 中的日期格式 getAvailableLocales()方法，示例

> 原文:[https://www . geesforgeks . org/dateform-getavailable locales-method-in-Java-with-examples/](https://www.geeksforgeeks.org/dateformat-getavailablelocales-method-in-java-with-examples/)

Java 中 **DateFormat 类**的 **getAvailableLocales()** 方法用于返回该类的 getInstance 方法的本地化实例中可用的所有区域设置的数组。
...
**参考:**[https://docs . Oracle . com/javae/7/docs/API/Java/text/date format . html # getavailablelocales()](https://docs.oracle.com/javase/7/docs/api/java/text/DateFormat.html#getAvailableLocales())